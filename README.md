...
The DOCX is used to enrich the documentation with business context that may not be visible in the screenshots, and is generated by the [PBIAutoDoc](https://github.com/LawrenceTeixeira/PBIAutoDoc) tool from Laurence Teixeira
